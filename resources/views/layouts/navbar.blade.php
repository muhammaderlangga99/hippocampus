            ...
            <ul
                ...
                <li>
                    <a href="/"
                        ...
                        hover:text-blue-500 @if (Request::is('/')) text-blue-700 bg-blue-50 @endif lg:p-0"
                ...
                <li>
                    <a href="/about"
                        class="block py-2 pl-3 pr-4 text-grey-700 rounded lg:bg-transparent
                        hover:text-blue-500 @if (Request::is('about')) text-blue-700 bg-blue-50 @endif lg:p-0">About</a>
                </li>
